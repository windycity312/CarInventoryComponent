...
export const EmpireFooter = () => {
    ...
    return (
        <Footer style={{ background: 'black', textAlign:'center' }}>
            <Row>
                <Col xs={24} sm={24} md={12} lg={6}><Logo /><div style={{clear:'left'}}/><Copyright /></Col>
                <Col xs={24} sm={24} md={12} lg={6}><QuickContact /></Col>
                <Col xs={24} sm={24} md={12} lg={6}>              {data.map((section, i) => (
                    <FooterLinkSection
                        title={section.title}
                        data={section.links}
                        key={i}
                ...
                <Col xs={24} sm={24} md={12} lg={6}><SocialMedia /></Col>
            </Row>
            <Row>
